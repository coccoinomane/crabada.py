...
"""
How to scan and store past events in the blockchain, using
web3.eth.get_logs.

Taken from https://web3py.readthedocs.io/en/stable/examples.html#advanced-example-fetching-all-token-transfer-events
