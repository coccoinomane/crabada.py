...
Usage:
    python3 -m bin.pangolin.swapTusToAvax <ur address> <amount of tus>
...
from src.swap import TUS_TO_AVAX_PATH, swapTokenToAvaxPangolin
...
swapTokenToAvaxPangolin(User(userAddress), tusAmountInWei, TUS_TO_AVAX_PATH)
